...
export default function Portfolio() {
    ...
    useEffect(() => {
        ...
        document.documentElement.style.setProperty('--color-primary', selectedColor.hsl);
        document.documentElement.style.setProperty('--color-primary-hover', selectedColor.hslHover);
